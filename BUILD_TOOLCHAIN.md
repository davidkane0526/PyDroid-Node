...
Current build revision: **1.6.54-dev-r149-primitive-content-footprint** (2026-08-26). The user has confirmed the pinned Windows/Android build compiles; tool discovery and the accepted 1.6.46 Gradle client/build JVM alignment remain unchanged. This release only reduces Primitive value-node content footprint and does not alter the accepted build path.
