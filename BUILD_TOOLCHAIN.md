...
Current build revision: **1.6.55-dev-r150-primitive-centered-rhythm** (2026-08-26). The user has confirmed the pinned Windows/Android build compiles; tool discovery and the accepted 1.6.46 Gradle client/build JVM alignment remain unchanged. This release only fixes Primitive full-card centering and title-control rhythm and does not alter the accepted build path.
