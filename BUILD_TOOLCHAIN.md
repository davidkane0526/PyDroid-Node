...
Current build revision: **1.6.48-dev-r143-node-content-balance** (2026-08-26). The user has confirmed the pinned Windows/Android build now compiles; tool discovery and the 1.6.46 Gradle client/build JVM alignment remain unchanged. This release only replaces fixed node width/height heuristics with content-driven two-dimensional card geometry.
