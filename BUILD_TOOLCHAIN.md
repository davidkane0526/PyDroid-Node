...
Current build revision: **1.6.52-dev-r147-primitive-micro-ui-polish** (2026-08-26). The user has confirmed the pinned Windows/Android build compiles; tool discovery and the accepted 1.6.46 Gradle client/build JVM alignment remain unchanged. This release changes primitive-node UI only and does not alter the accepted build path.
