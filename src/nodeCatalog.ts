...
export const NODE_CATALOG: NodeSpec[] = [
  ...
  },
  {
    ...
    outputPorts: TABLE_OUTPUT,
    parameters: [
      { key: "rowStart", label: "起始行", kind: "text", placeholder: "留空为首行" },
      { key: "rowStop", label: "结束行（不包含）", kind: "text", placeholder: "留空至末尾" },
      { key: "rowStep", label: "行步长", kind: "number", min: 1, step: 1 },
      { key: "columnStart", label: "起始列", kind: "text", placeholder: "留空为首列" },
  ...
  },
  {
    ...
    category: "统计",
    defaults: { groupSize: 25, tailRows: 10 },
    inputPorts: TABLE_INPUT,
    outputPorts: TABLE_OUTPUT,
    parameters: [
      { key: "groupSize", label: "周期行数", kind: "number", min: 1, step: 1 },
  ...
  },
  {
    ...
    category: "逻辑控制",
    defaults: { condition: "value >= 0" },
    inputPorts: [{ id: "input", label: "输入", valueType: "table", required: true }],
    outputPorts: [{ id: "true", label: "True", valueType: "table" }, { id: "false", label: "False", valueType: "table" }],
  ...
  },
  {
    ...
    inputPorts: TABLE_INPUT,
    outputPorts: [
      { id: "true", label: "成立", valueType: "table" },
      { id: "false", label: "不成立", valueType: "table" },
    ],
  ...
  },
  {
    ...
    inputPorts: [
      { id: "input", label: "输入表", valueType: "table", required: true },
      { id: "continue", label: "回传", valueType: "table" },
    ],
    outputPorts: [
      { id: "body", label: "循环体", valueType: "table" },
      { id: "done", label: "完成", valueType: "table" },
    ],
  ...
  },
  {
    ...
    category: "逻辑控制",
    defaults: { condition: "value < 10", maxIterations: 100 },
    inputPorts: [
      { id: "input", label: "初始表", valueType: "table", required: true },
      { id: "continue", label: "回传", valueType: "table" },
    ],
    outputPorts: [
      { id: "body", label: "循环体", valueType: "table" },
    ...
    parameters: [
      { key: "condition", label: "继续条件", kind: "text", required: true, placeholder: "value < 10", description: "使用 pandas query 表达式；当前表中至少一行满足时继续。" },
