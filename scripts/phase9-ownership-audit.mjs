...
assert.ok(appLines < 4400, `App.tsx still owns too much Phase 9 business logic (${appLines} lines)`);
...
console.log(`phase9 ownership audit passed (App.tsx ${appLines} lines)`);
