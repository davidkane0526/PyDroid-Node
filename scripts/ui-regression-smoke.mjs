...
const appShell = readFileSync(path.join(root, "src/App.tsx"), "utf8");
...
const uiFixes = ["shell-responsive.css", "panels.css", "result-presentation.css"].map((name) => readFileSync(path.join(root, "src/styles", name), "utf8")).join("\n");
