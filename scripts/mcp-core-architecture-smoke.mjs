...
assert.match(desktop, /127\.0\.0\.1/, "Desktop MCP must expose a loopback URL for same-machine clients");
assert.match(desktop, /localUrl/);
assert.match(desktop, /lanUrl/);
