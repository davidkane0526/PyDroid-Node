...
assert.match(protocol, /MCP_PROTOCOL_VERSION\s*=\s*"2026-07-28"/);
...
for (const source of [protocol, core, host, desktop, android]) {
  ...
  assert.doesNotMatch(source, /text\/event-stream|EventSource|sessionId|Mcp-Session-Id/i, "MCP 1.6.0 must remain stateless and SSE-free");
}
