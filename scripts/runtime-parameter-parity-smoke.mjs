...
execFileSync("tsc", ["--target","ES2022","--module","commonjs","--moduleResolution","node","--skipLibCheck","--outDir",out,"--rootDir",".","src/nodeCatalog.ts","src/nodeContract.ts"], { stdio:"inherit" });
const mod = await import(pathToFileURL(path.join(out,"src","nodeContract.js")).href);
